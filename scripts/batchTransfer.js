...
const contractAddress = "0x5d55C96B8B3109b3A6241aA608e95A7D06623475";
...
async function main() {
 ...
 for (let i = 1; i <= 699; i++) {
  ...
  for (let i = startReward; i < tokenIds.length; i += batchSize) {
    ...
    //  const transferTx = await contract.batchTransfer("0xB1C4e4156A4bdDDC4CE7eB05109C677AC91b4228", "0xe0A9e5B59701a776575fDd6257c3F89Ae362629a", transfersToSend);
